...
$tipoProducto = "Cereales y Snacks";
    ...
    <body>
        ...
        <br>
            ...
            <a class="list-group-item" href="busqueda_carnes.php"> <img src="../icons/carnes.png" width="30" height="30" alt="carnes"/>
                        &nbsp;Carnes</a>
            <a class="list-group-item active" href="busqueda_cereales_y_snacks.php"> <img src="../icons/cereales_y_snacks_w.png" width="30" height="30" alt="hogar_y_limpieza"/>
                        &nbsp;Cereales y Snacks</a>
