...
if(isset($_SESSION['cliente']) && isset($_SESSION['carro']) && isset($_SESSION['despacho']))
{
    ...
    <body>
        ...
        <br>
            ...
            <div class="w3-col m7 w3-card w3-padding">
                ...
                <form action="../process/create_metodo_pago.php" method="POST">        
                    ...
                    <div class="w3-table">
                        ...
                        <div class="w3-row w3-padding">
                            ...
                            <div class="w3-col m5">
                                <select name="dll_metodo_pago"
                                        class="form-control">
                                <?php
                                $metodosDePago = new MetodoDePagosDal();
                                
                                $metodosDePago->showMetodosDePagos();
                                ?>
                                </select>
                            </div>    
                            <div class="w3-col m1"></div>
                        ...
                        <div class="w3-row-padding">
                            <div class="w3-col m5">
                                <a class="btn btn-success btn-block" href="datos_despacho.php">
