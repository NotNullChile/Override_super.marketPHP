            ...
            <div class="w3-col m7 w3-card w3-padding">
                ...
                <div class="w3-container red">
                    ...
                    <form action="reportes.php" method="POST">  
                        <p align="right" > <button name="btn_reporte" formtarget="_blank" value="<?php //echo $sessionCliente['nombreReporte'] ?>" type="submit" class="btn btn-info"><i class="fa fa-file-text"> Listado Clientes</i></i></button>
