       ...
       <!--horizontal menu-->
        ...
        <br>
            ...
            <a class="list-group-item" href=index_administrador.php> <img src="../icons/Override.png" width="30" height="30" alt="Intranet Override"/>
                &nbsp;Home Intranet</a>
                <a class="list-group-item active" href="intranet_agregar_producto.php"><img src="../icons/new_product_w.png" width="30" height="30" alt=""/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" 
                                   ...
                                   value="<?php echo $productoDal->maxProducto()?>" 
                                   class="form-control"
                                   size="5" 
                                   readonly="readonly" />
                        </td>
