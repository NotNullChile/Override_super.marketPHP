...
<html>
    <head>
        ...
        <title>Editar o Midificar</title>
    ...
    <body>
        ...
        function ayuda() 
        {
            alert("Aquí puede visualizar los productos, pudiendo eliminarlos o modificarlos\nPara modificar los productos debe editar los campos que aparecen y presionar el botón Guadar Cambios.\nPara eliminar solo presionar el botón Eliminar Producto");          
        }
        </script>
        <!--header-->
        ...
        <br>
            ...
            <a class="list-group-item" href=index_administrador.php> <img src="../icons/Override.png" width="30" height="30" alt="Intranet Override"/>
                ...
                <a class="list-group-item active" href="intranet_buscar_producto.php"><img src="../icons/search_w.png" width="30" height="30" alt=""/>
                        &nbsp;Buscar Producto</a>
            ...
            {
                echo "<center> <h1> No existe producto buscado  </h1></center>";
            }
