...
<html>
	<head>
		...
		<title>Reporte Productos más Elegido</title>
    ...
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [
                <?php
                $c = new conexion();
                $sql = "SELECT count(v.idProducto) 'cantidad',p.nombreProducto from venta_producto v INNER JOIN productos p ON p.idProducto = v.idProducto "
                     . " GROUP BY 2;";
                //se conecta a la BD
                $conn = $c->conn();
                //Crea la consulta
                ...
                {
                ?>
                ['<?php echo $row['nombreProducto'];?>',   <?php echo $row['cantidad'];?>],
                <?php
                }
                ?>
